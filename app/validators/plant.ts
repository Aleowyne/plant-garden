...
export const createPlantValidator = vine.compile(
  vine.object({
    ...
    seedPotPeriod: vine.array(vine.enum(PlantService.months)),
    seedSoilPeriod: vine.array(vine.enum(PlantService.months)),
    plantationPeriod: vine.array(vine.enum(PlantService.months)),
    maturePeriod: vine.array(vine.enum(PlantService.months)),
